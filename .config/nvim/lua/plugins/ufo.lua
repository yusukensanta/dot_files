...
return {
	{
		...
		keys = {
			...
			},
			{
				...
				desc = "UFO: peek fold content",
			},
		},
		-- No init block needed: foldlevel/foldlevelstart are in options.lua.
		-- foldcolumn is intentionally left at the default ("0") — "auto" caused the
		-- left edge to shift by 1 column when jumping between folded/non-folded regions
		-- (e.g. G, gg), which looked like corruption. ufo works fine without a visible
		-- fold column; zR / zM / zK still function normally.
	},
}
